...
public class Mainlista {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < 10; i++) {
			vendas.add(new Venda(scan.next(), scan.nextInt(), scan.nextFloat()));// scanner de 3 objetos ao msm tempo
		}  
		...
		for(int i = 0; i < 10; i++) {
			...
			total += vendas.get(i).subTotal(); // acumular o total de vendas
			media += vendas.get(i).preco; // acumular o preco total dos produtos
		...
		System.out.printf("Mais vendido: %s", vendas.get(vendido).toString());
